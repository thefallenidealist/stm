...
/*
   ...
   higher level sranja
   nazivi low level funkcija su isti za paralelni i serijski LCD, ne mogu oba zajedno radit. Zasad.
...
//void glcd_hline(vuint16_t x0, vuint16_t y0, vuint16_t length, vuint16_t color)
// volatile tipovi uspore dosta (113 vs 81 ms)
